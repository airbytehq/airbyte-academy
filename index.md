...
- [Lesson 3: Get the API Credentials](docs/api-fundamentals/lesson_3.md)
- [Lesson 4: Build a Pipeline using the Python SDK and Airbyte API](docs/api-fundamentals/lesson_4.md)
